package com.ducgiang.identify_service;
...
class IdentifyServiceApplicationTests {
	...
	void hash() throws NoSuchAlgorithmException {
		...
		log.info("MD5 round 1: {}" , md5Hash); // E10ADC3949BA59ABBE56E057F20F883E
		md.update(password.getBytes());
		digest =  md.digest();
		md5Hash = DatatypeConverter.printHexBinary(digest);
		log.info("MD5 round 2: {}" , md5Hash); // E10ADC3949BA59ABBE56E057F20F883E
